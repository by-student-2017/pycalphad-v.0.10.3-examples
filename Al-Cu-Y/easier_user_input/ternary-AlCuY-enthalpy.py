...
c = calculate(tdb, comps, 'FCC_A1', output='HM_MIX', T=Temp, P=101325, pdens=5000)
...
ax.set_title(img_title_comps+' HM_MIX at '+str(Temp)+' K')
...
output_file = 'ternary-'+img_comps+"-"+str(Temp)+'K-enthalpy.png'
